  ...
  return (
    <div className="w3-white w3-text-grey w3-card-4 w3-margin-bottom">
      ...
      <div className="w3-container">
        ...
        <p>
          <i className="fa-fw w3-margin-right w3-large w3-text-teal fa fa-briefcase"></i>
          Full Stack Developer
        </p>
        <p>
          <i className="fa-fw w3-margin-right w3-large w3-text-teal fa fa-envelope"></i>
          chlee125@gmail.com
        </p>
        <p>
          <a
            href="https://github.com/chlee125"
            target="_blank"
