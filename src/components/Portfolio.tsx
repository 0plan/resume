  ...
  const portfolios = [
    {
      ...
      desc: [
        '학적부 보관실에서 업무처리를 빠르게 하기위해 AutoHotKey로 개발하였습니다.',
    ...
    },
    {
      ...
      desc: [
        'Hybrid Web & Index 개발자 과정 Semi Project 로 Cordova를 사용한 일정관리 웹 앱 개발에 참여하였습니다.',
    ...
    },
    {
      ...
      desc: [
        'Hybrid Web & Index 개발자 과정 Final Project 로 Spring Framework 를 기반으로 개발했습니다.',
    ...
    },
    {
      ...
      desc: [
        '모바일 출결관리 웹앱의 Front End 및 Back End 를 작업하였습니다.',
        'Progressive Web Index (PWA) 으로 개발 되었습니다.',
      ],
      image: 'apad.png',
    },
    {
      ...
      desc: [
        '외출 및 외박을 신청할 수 있는 웹앱의 Front End 및 Back End 를 작업하였습니다.',
        'Progressive Web Index(PWA) 으로 개발 되었습니다.',
      ],
      image: 'gohome.png',
    },
    {
      ...
      desc: [
        '2019년 12월: Slack Bot 을 이용한 운영 업무 처리 기능 개발',
    ...
    },
    {
      ...
      desc: [
        '2021년 2월 까지 현업 부서 요구 사항에 따른 기능 개발',
    ...
    },
    {
      ...
      date: { from: '2019년 12월', to: '2022년 2월' },
      desc: [
        'Python 을 이용하여 DB Connection, 내부 API Server curl 요청',
        '이후 Airflow 로 전환 예정',
      ],
    },
    {
    ...
    },
    {
      ...
      date: { from: '2019년 9월', to: '2022년 2월' },
      desc: [
        '형상관리: Git Branch 정책 관리 및 사용자 관리',
    ...
    // "앱개발: Google Play Store, Apple Index Store"]
    // },
    {
      position: 'Nuxt.js',
      name: 'LG U+ 로봇 관리 플랫폼',
    ...
    },
    {
      ...
      desc: ['Nuxt + Vue2 + Composition API'],
    },
    {
      position: 'Nuxt.js',
      name: 'LG U+ 데이터레이크',
    ...
    },
    {
      ...
      desc: ['Vite + Vue3 + typescript', 'Frontend PL 및 개발'],
    },
    {
      position: 'Vue3',
        ...
        <div className="w3-container w3-card-4 w3-white w3-margin-bottom">
          <div className="w3-container">
            <h2 className="w3-text-grey w3-padding-16">
              <i className="fa fa-folder fa-fw w3-margin-right w3-xxlarge w3-text-teal" />
              Portfolio
            </h2>
          </div>
